...
public class WatchlistServiceTest {
    ...
    class AddStockToWatchlist {
        ...
        void addStockToWatchlist_throwsException_whenStocksExistsInWatchList() {
            ...
            when(userRepository.findByUsername("Bukola")).thenReturn(Optional.of(user));
            when(stockService.getStockBySymbol("AAPL")).thenReturn(stockInWatchlist);
        ...
        void addStockToWatchlist_succeeds_whenStockNotInWatchlist() {
            ...
            watchlistService.addStockToWatchlist("AAPL", "Bukola");
